  ...
  const loadReports = async () => {
    try {
      ...
      const [att, leave, lateRes, ot, wfhRes] = await Promise.all([
        api.get(`/api/reports/admin/attendance/${suffix}`, { params }),
        api.get(`/api/reports/admin/leaves/${suffix}`, { params }),
        api.get(`/api/reports/admin/late/${suffix}`, { params }),
        api.get(`/api/reports/admin/overtime/${suffix}`, { params }),
        api.get(`/api/reports/admin/wfh/${suffix}`, { params }),
      ]);
    ...
    <div className="reports-dashboard">
      ...
      <div className="report-grid">
        <Card title="Attendance">
          <PieView
            data={attendancePie(data.attendance)}
            unit="%"
